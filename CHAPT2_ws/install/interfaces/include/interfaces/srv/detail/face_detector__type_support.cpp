...
{
  new (message_memory) interfaces::srv::FaceDetector_Request(_init);
}

void FaceDetector_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::FaceDetector_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FaceDetector_Request_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::srv::FaceDetector_Request, image),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FaceDetector_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::FaceDetector_Request),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::FaceDetector_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, FaceDetector_Request)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::FaceDetector_Request_message_type_support_handle;
}
...
void FaceDetector_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interfaces::srv::FaceDetector_Response(_init);
}

void FaceDetector_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::FaceDetector_Response *>(message_memory);
...
size_t size_function__FaceDetector_Response__bottem(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__FaceDetector_Response__bottem(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void * get_function__FaceDetector_Response__bottem(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void resize_function__FaceDetector_Response__bottem(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FaceDetector_Response_message_member_array[6] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::FaceDetector_Response, number),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::FaceDetector_Response, use_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::FaceDetector_Response, top),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::FaceDetector_Response, right),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::FaceDetector_Response, bottem),  // bytes offset in struct
    nullptr,  // default value
    size_function__FaceDetector_Response__bottem,  // size() function pointer
    get_const_function__FaceDetector_Response__bottem,  // get_const(index) function pointer
    get_function__FaceDetector_Response__bottem,  // get(index) function pointer
    resize_function__FaceDetector_Response__bottem  // resize(index) function pointer
  },
  {
    "left",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_INT32,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::FaceDetector_Response, left),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FaceDetector_Response_message_members = {
  ...
  6,  // number of fields
  sizeof(interfaces::srv::FaceDetector_Response),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::FaceDetector_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, FaceDetector_Response)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::FaceDetector_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers FaceDetector_service_members = {
  ...
  // see get_service_type_support_handle<interfaces::srv::FaceDetector>()
...
get_service_type_support_handle<interfaces::srv::FaceDetector>()
{
  ...
  auto service_type_support =
    &::interfaces::srv::rosidl_typesupport_introspection_cpp::FaceDetector_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::interfaces::srv::FaceDetector_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::interfaces::srv::FaceDetector_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, FaceDetector)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interfaces::srv::FaceDetector>();
}
