...
class FaceDetector_Response(metaclass=Metaclass_FaceDetector_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.bottem = array.array('i', kwargs.get('bottem', []))
    ...
    @property
    def bottem(self):
        """Message field 'bottem'."""
        return self._bottem

    @bottem.setter
    def bottem(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'bottem' array.array() must have the type code of 'i'"
            self._bottem = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -2147483648 and val < 2147483648 for val in value)), \
                "The 'bottem' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._bottem = array.array('i', value)
...
class Metaclass_FaceDetector(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _face_detector
...
class FaceDetector(metaclass=Metaclass_FaceDetector):
    from interfaces.srv._face_detector import FaceDetector_Request as Request
    from interfaces.srv._face_detector import FaceDetector_Response as Response
