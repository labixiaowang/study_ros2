...
#include "interfaces/srv/detail/face_detector__rosidl_typesupport_fastrtps_c.h"
...
using _FaceDetector_Request__ros_msg_type = interfaces__srv__FaceDetector_Request;
...
size_t get_serialized_size_interfaces__srv__FaceDetector_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FaceDetector_Request__ros_msg_type * ros_message = static_cast<const _FaceDetector_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FaceDetector_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__FaceDetector_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__FaceDetector_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__srv__FaceDetector_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, FaceDetector_Request)() {
...
#include "rosidl_runtime_c/primitives_sequence.h"  // bottem, left, right, top
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // bottem, left, right, top

// forward declare type support functions


using _FaceDetector_Response__ros_msg_type = interfaces__srv__FaceDetector_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bottem
  {
    size_t size = ros_message->bottem.size;
    auto array_ptr = ros_message->bottem.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: top
  {
    ...
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->top, size)) {
      return "failed to create array for field 'top'";
    }
    auto array_ptr = ros_message->top.data;
  ...
  // Field name: bottem
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->bottem.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->bottem);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->bottem, size)) {
      return "failed to create array for field 'bottem'";
    }
    auto array_ptr = ros_message->bottem.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__srv__FaceDetector_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FaceDetector_Response__ros_msg_type * ros_message = static_cast<const _FaceDetector_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__FaceDetector_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__FaceDetector_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__srv__FaceDetector_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, FaceDetector_Response)() {
...
// already included above
// #include "interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "interfaces/srv/face_detector.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, FaceDetector)() {
